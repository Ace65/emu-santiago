...
CREATE TABLE `legion_members` (
  ...
  `rank` enum('BRIGADE_GENERAL','DEPUTY','CENTURION','LEGIONARY','VOLUNTEER') NOT NULL default 'VOLUNTEER',
...
CREATE TABLE `players` (
  ...
  `motion` varchar(8) NOT NULL DEFAULT '0,0,0,0',
  `motion_ninja` tinyint(1) NOT NULL DEFAULT '0',
  `motion_levitate` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_unique` (`name`),
