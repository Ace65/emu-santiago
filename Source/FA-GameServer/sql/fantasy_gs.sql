...
CREATE TABLE `legion_members` (
  ...
  `rank` enum('BRIGADE_GENERAL','DEPUTY','CENTURION','VOLUNTEER','NEW_LEGIONARY') NOT NULL default 'VOLUNTEER',
...
CREATE TABLE `players` (
  ...
  `personal_rating` int(11) NOT NULL DEFAULT '0',
...
ALTER TABLE `players` ADD CONSTRAINT `setPartnerNull` FOREIGN KEY (`partner_id`) REFERENCES `players` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
...
CREATE TABLE `arena_teams` (
  ...
  `team_type` int(2) NOT NULL DEFAULT '0',
  `mmr` int(11) NOT NULL DEFAULT '0',
  `team_name` varchar(150) NOT NULL,
  `players` text NOT NULL,
  PRIMARY KEY (`team_id`),
  UNIQUE KEY `name_unique` (`team_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `player_rates_xp`
-- ----------------------------
DROP TABLE IF EXISTS `player_rates_xp`;
CREATE TABLE `player_rates_xp` (
  `player_id` int(11) NOT NULL,
  `xp_rate` int(1) NOT NULL DEFAULT '1',
  `quest_xp_rate` int(1) NOT NULL DEFAULT '1',
  `group_xp_rate` int(1) NOT NULL DEFAULT '1',
  `drop_rate` int(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`player_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
