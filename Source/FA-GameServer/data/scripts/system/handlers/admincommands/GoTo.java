...
public class GoTo extends AdminCommand
{
	...
	public void executeCommand(Player admin, String[] params)
	{
		...
		else if (params[0].toLowerCase().equals("testdungeon"))
		{
			TeleportService.teleportTo(admin, 300020000, 140, 130, 25, 0);
			PacketSendUtility.sendMessage(admin, "Teleported to Test Dungeon.");
		}
        ...
        {	
            TeleportService.teleportTo(admin, 300250000, getInstanceId(300250000, admin), 363, 535, 325, 0);
           	PacketSendUtility.sendMessage(admin, "Teleported to Esoterrace");
       	} 
		
		else if (params[0].toLowerCase().equals("empyream"))
        {	
            TeleportService.teleportTo(admin, 300300000, getInstanceId(300300000, admin), 1787, 797, 470, 0);
