...
public class AddCredits extends AdminCommand {
    ...
    public void executeCommand(Player admin, String[] params) {
        ...
        PacketSendUtility.sendMessage(admin, name + " Increase " + Credits + " Toll/s success.");
        PacketSendUtility.sendMessage(player, "Admin " + admin.getName() + " You increase " + Credits + " Toll/s.");
    }
}
