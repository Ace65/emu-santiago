...
public class Dye extends AdminCommand
{
	...
	public void executeCommand(Player admin, String[] params)
	{
		...
		long dyeAmount = AdminConfig.COMMAND_DYEAMOUNT;
        Storage source =  admin.getStorage(StorageType.CUBE.getId());
        long adminKinah = source.getKinahCount();
        
        if(adminKinah < dyeAmount)
        {
		...
		source.decreaseKinah(dyeAmount);
	}
}
