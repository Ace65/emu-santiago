...
{
	private final static int questId = 11267;
		...
		if(qs == null || qs.getStatus() == QuestStatus.NONE)
		{
			if(targetId == 799038) //Laestrygos
			{
				switch(env.getDialogId())
				{
					...
					case 1002:
						if (!ItemService.addItems(player, Collections.singletonList(new QuestItems(182206886, 1)))); //Piece Of Aegis
            ...
            switch (targetId)
			{
                ...
                case 798316:
					...
					{   
                        ...
                        case 34:
                            //Piece Of Aegis (1)
						    //Laestrygos's Sword (1)
                            //Kinah (8000000)
                            if (QuestService.collectItemCheck(env, true))
	          {                 
                                player.getInventory().removeFromBagByItemId(182206886, 1); //Piece Of Aegis
                                player.getInventory().removeFromBagByItemId(100000940, 1); //Laestrygos's Sword
