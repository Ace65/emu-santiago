...
public class _11259Mace_Predilection extends QuestHandler
{
	private final static int questId = 11259;

	public _11259Mace_Predilection()
	{
		super(questId);
	}
		...
		if(qs == null || qs.getStatus() == QuestStatus.NONE)
		{
			if(targetId == 799038) //Laestrygos
			{
				switch(env.getDialogId())
				{
					...
					case 1002:
						if (!ItemService.addItems(player, Collections.singletonList(new QuestItems(182206882, 1)))); //Piece Of Aegis
