...
public class _11261Orb_Predilection extends QuestHandler
{
	private final static int questId = 11261;

	public _11261Orb_Predilection()
	{
		super(questId);
	}
		...
		if(qs == null || qs.getStatus() == QuestStatus.NONE)
		{
			if(targetId == 799038) //Laestrygos
			{
				switch(env.getDialogId())
				{
					...
					case 1002:
						if (!ItemService.addItems(player, Collections.singletonList(new QuestItems(182206883, 1)))); //Piece Of Aegis
