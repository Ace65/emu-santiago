...
public class _30308GroupSummonRespondentUtra extends QuestHandler 
{
	...
	public void register()
	{
		...
		qe.setNpcQuestData(799504).addOnTalkEvent(questId);
	}
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(targetId == 799322)
		{
			if(qs == null || qs.getStatus() == QuestStatus.NONE)
			{
				...
				{
					if (ItemService.addItems(player, Collections.singletonList(new QuestItems(182209710, 1))))
		...
		else if(targetId == 730274)
		{
			if(qs != null && qs.getStatus() == QuestStatus.START && qs.getQuestVarById(0) == 0)
			{
				if(env.getDialogId() == -1)
				{
					...
					player.getInventory().removeFromBagByItemId(182209710, 1);	
					qs.setQuestVar(1);		
					updateQuestStatus(env);					
					QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 799504, (float) 1357.8579, (float) 394.0854, (float) 249.25418, (byte) 0, true);
				}
			}
		}
