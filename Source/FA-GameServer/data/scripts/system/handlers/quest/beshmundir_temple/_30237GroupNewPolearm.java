 ...
 * 
 */
public class _30237GroupNewPolearm extends QuestHandler
{
	private final static int	questId	= 30237;

	public _30237GroupNewPolearm()
	{
		super(questId);
	}
	...
	public HandlerResult onItemUseEvent(final QuestCookie env, Item item)
	{
		...
		if(id == 186000107)
		{
			...
			if(qs.getQuestVarById(0) != 0)
				return HandlerResult.FAILED;
			if(player.getInventory().getItemCountByItemId(101300686) == 0 || player.getInventory().getItemCountByItemId(186000099) == 0
			...
			ThreadPoolManager.getInstance().schedule(new Runnable(){
				...
				public void run()
				{
					ItemService.addItems(player, Collections.singletonList(new QuestItems(182209635, 1)));
