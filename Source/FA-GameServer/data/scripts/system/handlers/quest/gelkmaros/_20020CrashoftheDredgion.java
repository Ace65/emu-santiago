...
public class _20020CrashoftheDredgion extends QuestHandler
{
	...
	private final static int[]	npc_ids	= {799225, 799226, 799239, 798703}; //799342
	...
	public void register()
	{
		...
		qe.setNpcQuestData(216545).addOnKillEvent(questId);
	}
	...
	public boolean onEnterZoneEvent(QuestCookie env, ZoneName zoneName)
	{
		...
		{
			PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 559));
			return true;
		}
		return false;
	}
	...
	public boolean onKillEvent(QuestCookie env)
	{
		...
		if(qs.getStatus() == QuestStatus.START)
		{	
			if(player.getCommonData().getPosition().getMapId() == 220070000)
			{
