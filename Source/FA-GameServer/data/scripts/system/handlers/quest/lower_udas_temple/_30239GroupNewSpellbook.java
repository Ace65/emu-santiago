...
public class _30239GroupNewSpellbook extends QuestHandler
{
	private final static int	questId	= 30239;

	public _30239GroupNewSpellbook()
	{
		super(questId);
	}
	...
	public HandlerResult onItemUseEvent(final QuestCookie env, Item item)
	{
		...
		if(id == 186000107)
		{
			...
			if(qs.getQuestVarById(0) != 0)
				return HandlerResult.FAILED;
			if(player.getInventory().getItemCountByItemId(100600787) == 0 || player.getInventory().getItemCountByItemId(186000099) == 0
			...
			ThreadPoolManager.getInstance().schedule(new Runnable(){
				...
				public void run()
				{
					ItemService.addItems(player, Collections.singletonList(new QuestItems(182209637, 1)));
