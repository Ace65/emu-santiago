 ...
 * 
 */
public class _3721GroupDisarmtheChantraDredgion extends QuestHandler
{
	private final static int	questId	= 3721;

	public _3721GroupDisarmtheChantraDredgion()
	{
		super(questId);
	}
	...
	{
		qe.setNpcQuestData(798928).addOnQuestStart(questId);
