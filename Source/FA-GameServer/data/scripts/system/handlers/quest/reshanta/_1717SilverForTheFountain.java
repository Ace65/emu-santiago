...
public class _1717SilverForTheFountain extends QuestHandler
{
	...
	{
		qe.setNpcQuestData(730142).addOnQuestStart(questId);
		qe.setNpcQuestData(730142).addOnTalkEvent(questId);
		qe.setNpcQuestData(730142).addOnActionItemEvent(questId);
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(qs.getStatus() == QuestStatus.REWARD && env.getTargetId() == 730142)
		{
