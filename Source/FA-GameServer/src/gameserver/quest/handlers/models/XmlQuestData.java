...
public class XmlQuestData extends QuestScriptData
{
	 ...
	 * (non-Javadoc)
	 * @see
	 * gameserver.quest.handlers.models.QuestScriptData#register(.gameserver.quest
	 * .QuestEngine)
	 */
	@Override
	public void register(QuestEngine questEngine)
	{
		...
		if(!questEngine.TEMP_HANDLERS.containsKey(h.getQuestId()))
			questEngine.TEMP_HANDLERS.put(h.getQuestId(), h);
	}
}
