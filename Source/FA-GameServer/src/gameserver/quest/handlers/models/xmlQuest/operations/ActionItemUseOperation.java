...
public class ActionItemUseOperation extends QuestOperation
{
	...
	/*
	 * (non-Javadoc)
	 * @see gameserver.questEngine.handlers.models.xmlQuest.operations.QuestOperation#doOperate(.
	 * gameserver.services.QuestService, gameserver.quest.model.QuestEnv)
	 */
	@Override
