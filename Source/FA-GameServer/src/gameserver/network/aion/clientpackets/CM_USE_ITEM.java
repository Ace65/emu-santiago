...
public class CM_USE_ITEM extends AionClientPacket {
	...
	protected void runImpl() 
	{
		...
		if (item.getItemId() == 164002014 ||item.getItemId() == 164002019 ||item.getItemId() == 164000136||item.getItemId() == 164002009) {
			PacketSendUtility.sendPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), item.getObjectId(), item.getItemTemplate().getTemplateId(), 0, 1, 0));
