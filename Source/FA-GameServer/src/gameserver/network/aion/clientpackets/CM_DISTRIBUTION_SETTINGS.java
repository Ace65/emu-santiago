	...
	protected void runImpl()
	{
		...
		if(leader != null)
		{
			...
			}else if(leader.isInGroup())
			{
				...
				if (pg.isMentoring(leader) && lootrules == LootRuleType.LEADER) {
					PacketSendUtility.sendPacket(leader, SM_SYSTEM_MESSAGE.STR_MSG_DONT_SELECT_LEADER_LOOTING_BY_MENTOR());
					return;
				}
				if(pg != null)
				{
