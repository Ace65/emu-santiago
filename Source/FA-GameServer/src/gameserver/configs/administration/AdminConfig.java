...
public class AdminConfig
{
	...
	@Property(key = "gameserver.administration.command.dyeamount", defaultValue = "3")
	public static int COMMAND_DYEAMOUNT;
	...
	@Property(key = "gameserver.administration.command.resetmotion.full", defaultValue = "3")
	public static int   COMMAND_RESET_MOTION_GM;

	@Property(key = "gameserver.administration.command.tvt", defaultValue = "1")
	public static int	COMMAND_TVT;
	...
	@Property(key = "gameserver.administration.command.addcredits", defaultValue = "3")
