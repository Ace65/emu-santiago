...
public class GSConfig
{
	 ...
	 * Server Version
	 */
	@Property(key = "gameserver.version", defaultValue = "2.7.0.0")
	...
	@Property(key = "gameserver.factions.ratio.lastonline.enable", defaultValue = "true")
	public static boolean		FACTIONS_RATIO_LAST_ONLINE_ENABLE;
	
	@Property(key = "gameserver.factions.ratio.lastonline.days", defaultValue = "30")
	public static int		FACTIONS_RATIO_LAST_ONLINE_DAYS;
