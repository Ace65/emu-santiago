...
public class CustomConfig
{
	 ...
	 * Login level
	 */
	@Property(key = "gameserver.Login.level", defaultValue = "1")
	 ...
	 * Warehouse Size
	 */
	@Property(key = "gameserver.Warehouse.size", defaultValue = "0")
	public static int WAREHOUSE_SIZE;
	...
	/**
	 * Level restriction custom channel .world
	 */
	@Property(key = "gameserver.channels.level.restriction", defaultValue = "55")
	public static byte		CHANNEL_LEVEL_RESTRICTION;
	...
	@Property(key = "gameserver.gmtag.level1", defaultValue = "<SUPPORT>")
	public static String		GM_LEVEL1;

	@Property(key = "gameserver.gmtag.level2", defaultValue = "<ANIM>")
	public static String		GM_LEVEL2;

	@Property(key = "gameserver.gmtag.level3", defaultValue = "<GM>")
	public static String		GM_LEVEL3;

	@Property(key = "gameserver.gmtag.level4", defaultValue = "<HEADGM>")
	public static String		GM_LEVEL4;

	@Property(key = "gameserver.gmtag.level5", defaultValue = "<ADMIN>")
	...
	/**
	 * Chain trigger rate. If false all Chain non 100% are % success.
	 */ 
	...
	*/
	...
	@Property(key = "gameserver.motion.retail", defaultValue = "true")
	public static boolean       RETAIL_MOTION;
	...
	@Property(key = "gameserver.item.remodel_all", defaultValue = "false")
	public static boolean ITEM_REMODEL_ALL;
	...
	*/
	...
	/**
	* Time between using worldchat by Khaos
	*/
