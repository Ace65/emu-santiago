...
public class RateConfig
{
	...
	*/
	...
	@Property(key = "gameserver.rate.vip.group.xp", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.xp", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.quest.xp", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.gathering.xp", defaultValue = "1")
	...
	@Property(key = "gameserver.rate.vip.gathering.lvl", defaultValue = "1")
	...
	@Property(key = "gameserver.rate.vip.crafting.xp", defaultValue = "1")
	...
	@Property(key = "gameserver.rate.vip.crafting.lvl", defaultValue = "1")
	...
	@Property(key = "gameserver.rate.vip.quest.kinah", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.drop", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.chest.vip.drop", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.ap.player", defaultValue = "4")
	...
	@Property(key = "gameserver.rate.vip.ap.npc", defaultValue = "4")
	public static float	VIP_AP_NPC_RATE;

    /**
     * Abyss Points Lose Rate - Regular,Vip and Premium
     */
	...
	@Property(key = "gameserver.rate.vip.kinah", defaultValue = "4")
	public static int	VIP_KINAH_RATE;
	
	/**
	 * Empyrean Crucible Insignia Reward Rate
	 */
	@Property(key = "gameserver.rate.regular.insignia", defaultValue = "1")
	public static int	INSIGNIA_RATE;

	@Property(key = "gameserver.rate.premium.insignia", defaultValue = "2")
	public static int	PREMIUM_INSIGNIA_RATE;
	
	@Property(key = "gameserver.rate.vip.insignia", defaultValue = "3")
	public static int	VIP_INSIGNIA_RATE;
}
