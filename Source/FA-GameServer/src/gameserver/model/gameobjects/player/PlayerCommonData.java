...
public class PlayerCommonData extends VisibleObjectTemplate
{
	...
	private int				cubeSize				= CustomConfig.CUBE_SIZE;
	private int				warehouseSize			= CustomConfig.WAREHOUSE_SIZE;
	...
	public void setExp(long exp)
	{
		...
		if(getPlayerClass() != null && getPlayerClass().isStartingClass())
			maxLevel = CustomConfig.STARTCLASS_LEVEL;
    ...
    /**
     * @param arenaPoints the arenaPoints to set
     */
