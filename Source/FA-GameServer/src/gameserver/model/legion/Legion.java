...
public class Legion
{
    ...
    private int  									deputyPermission1 			= 0x0C; // Default Value when clic Default in game
    private int  									deputyPermission2			= 0x1E; // Default Value when clic Default in game
    private int  									centurionPermission1 		= 0x08; // Default Value when clic Default in game
    private int  									centurionPermission2 		= 0x1C; // Default Value when clic Default in game
    private int  									legionaryPermission1 		= 0x00; // Default Value when clic Default in game
    private int  									legionaryPermission2 		= 0x18; // Default Value when clic Default in game
	private int                                     volunteerPermission1        = 0x00; // Default Value when clic Default in game
    private int 									volunteerPermission2 		= 0x08; // Default Value when clic Default in game
