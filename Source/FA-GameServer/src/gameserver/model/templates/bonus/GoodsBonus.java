...
public class GoodsBonus extends AbstractInventoryBonus
{
	...
	/* (non-Javadoc)
	 * @see com.zettacore.gameserver.itemengine.bonus.AbstractInventoryBonus#canApply(gameserver.model.gameobjects.player.Player, .gameserver.model.gameobjects.Item, int)
	 */
	@Override
