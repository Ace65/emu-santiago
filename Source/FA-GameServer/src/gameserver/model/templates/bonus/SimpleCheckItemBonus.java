...
public abstract class SimpleCheckItemBonus extends AbstractInventoryBonus
{
	...
	/* (non-Javadoc)
	 * @see gameserver.model.templates.bonus.AbstractInventoryBonus#apply(.gameserver.model.gameobjects.player.Player, com.aionemu.gameserver.model.gameobjects.Item)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gameserver.model.templates.bonus.AbstractInventoryBonus#canApply(.gameserver.model.gameobjects.player.Player, com.aionemu.gameserver.model.gameobjects.Item, int)
	 */
	@Override
