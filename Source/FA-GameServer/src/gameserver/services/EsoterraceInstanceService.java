...
public class EsoterraceInstanceService
{
    ...
    public void onGroupReward(Monster monster, PlayerGroup group)
    {
		...
		// When kills Captain Murugan spawn 6 boxes
		if(monster.getObjectTemplate().getTemplateId() == 217195) {
			SpawnMuruganChest(group);
		}
    ...
    {   
		muruganchest = new VisibleObject[6];
		muruganchest[0] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 824.3317, (float) 1140.9674, (float) 365.03122, (byte) 1, true);
		muruganchest[1] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 826.5758, (float) 1136.959, (float) 365.03122, (byte) 1, true);
		muruganchest[2] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 830.07947, (float) 1132.4865, (float) 365.03122, (byte) 1, true);
		muruganchest[3] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 754.50793, (float) 1139.7252, (float) 365.03116, (byte) 1, true);
		muruganchest[4] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 751.5661, (float) 1136.5875, (float) 365.03116, (byte) 1, true);
		muruganchest[5] = (Npc) InstanceService.addNewSpawn(mapId, group.getGroupLeader().getInstanceId(), 701024, (float) 749.0317, (float) 1132.873, (float) 365.03116, (byte) 1, true);
    }
