	...
	public void playerStatusInfo(Player actingMember, int status, int playerObjId)
	{
		...
		switch(status)
		{
			...
			case 21: // Check Readiness State
				...
				break;
			case 25: // Appoint Alliance ViceCaptain
				...
				break;
			case 26: // Demote Alliance ViceCaptain
