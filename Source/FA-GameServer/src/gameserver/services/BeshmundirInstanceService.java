    ...
    public void onGroupReward(Monster monster, PlayerGroup group)
    {
        ...
        if(monster.getObjectTemplate().getTemplateId() == 216739) {
            ...
            if (group.getInstanceKills() == 15){
                ...
                Ahbana = SpawnEngine.getInstance().addNewSpawn(300170000, group.getGroupLeader().getInstanceId(), 216158, 1356f, 96f, 247f, (byte)89, 0, 0, true);
        ...
        else if(monster.getObjectTemplate().getTemplateId() == 216179)
        {
            ...
            SpawnEngine.getInstance().spawnObject(spawn, group.getGroupLeader().getInstanceId());
            //Mystery Box                        
            box = SpawnEngine.getInstance().addNewSpawn(300170000, group.getGroupLeader().getInstanceId(), 216764, 1544.95f, 1516.64f, 304.6232f, (byte)17, 0, 0, true);
            SpawnEngine.getInstance().spawnObject(box, group.getGroupLeader().getInstanceId());
        }
