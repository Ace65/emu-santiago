...
public class SiegeService
{
	...
	private boolean goesVulnerablePvE(int locationId, int day, int hour)
	{
		...
		{
			case 1011:
				if((day == 2 && hour == 22) || (day == 6 && hour == 22))
					return true;
				break;
			case 1131:
				if((day == 1 && hour == 22) || (day == 3 && hour == 22) || (day == 5 && hour == 22))
					return true;
				break;
			case 1132:
				if((day == 1 && hour == 22) || (day == 3 && hour == 22) || (day == 5 && hour == 22))
			...
			case 1141:
				...
				break;
			case 1211:
				if((day == 2 && hour == 22) || (day == 4 && hour == 22) || (day == 6 && hour == 22) || (day == 0 && hour == 22))
					return true;
				break;
			case 1221:
				if((day == 2 && hour == 22) || (day == 4 && hour == 22) || (day == 6 && hour == 22) || (day == 0 && hour == 22))
			...
			case 1251:
				...
				break;
			case 2011:
				if((day == 4 && hour == 14) || (day == 6 && hour == 14) || (day == 0 && hour == 14) || (day == 1 && hour == 20) || (day == 2 && hour == 20) || (day == 3 && hour == 20) || (day == 4 && hour == 20) || (day == 5 && hour == 20) || (day == 6 && hour == 20) || (day == 0 && hour == 20))
					return true;
				break;
			case 2021:
				if((day == 2 && hour == 14) || (day == 6 && hour == 14) || (day == 0 && hour == 14) || (day == 1 && hour == 20) || (day == 2 && hour == 20) || (day == 3 && hour == 20) || (day == 4 && hour == 20) || (day == 5 && hour == 20) || (day == 6 && hour == 20) || (day == 0 && hour == 20))
					return true;
				break;
			case 3011:
				if((day == 4 && hour == 14) || (day == 6 && hour == 14) || (day == 0 && hour == 14) || (day == 1 && hour == 20) || (day == 2 && hour == 20) || (day == 3 && hour == 20) || (day == 4 && hour == 20) || (day == 5 && hour == 20) || (day == 6 && hour == 20) || (day == 0 && hour == 20))
	...
	public boolean isSiegeNpc(int objectId)
	{
		for(Entry<Integer, List<Integer>> entry : fortressRelatedObjectIds.entrySet())
		{
			...
			{
				SiegeLocation loc = locations.get(entry.getKey());
				if(loc != null && loc.isVulnerable())
					return true;
				else
					return false;
			}
	...
	public boolean spawnLocation(int locationId, SiegeRace spawnRace, String spawnType)
	{
		...
		else if(location.getSiegeType() == SiegeType.FORTRESS)
		{
			...
			else if(spawnType.equals("SIEGE"))
			{
				// SIEGE !!
				// 1. Guards
				for(final SiegeGuardTemplate guardTemplate : guards)
				{
					int npcId = guardTemplate.getNpcId(spawnRace);
					if(npcId == 0)
						continue;
					for(SiegeSpawnLocationTemplate spawnLoc : guardTemplate.getSpawnLocations())
					{
						...
						if(result != null)
						{
							...
							final SiegeRace sRace = location.getRace();
							result.getKnownList().doOnAllPlayers(new Executor<Player>(){
                                @Override
                                public boolean run(Player player)
                                {
                                    if(
                                            (sRace == SiegeRace.ASMODIANS && player.getCommonData().getRace() != Race.ASMODIANS)
                                            || (sRace == SiegeRace.ELYOS && player.getCommonData().getRace() != Race.ELYOS)
                                            || sRace == SiegeRace.BALAUR
                                      )
                                        TeleportService.moveToBindLocation(player, true);
                                    return true;
                                }
                            });
							result.getKnownList().doOnAllNpcs(new Executor<Npc>(){
							    @Override
							    public boolean run(Npc npc)
							    {
							        if(!isSiegeNpc(npc.getObjectId()))
				...
				if(general != null)
				{
					...
					general.getKnownList().doOnAllNpcs(new Executor<Npc>(){
                    @Override
                        public boolean run(Npc npc)
                        {
                            if(!isSiegeNpc(npc.getObjectId()))
	...
	public void onFortressCaptured(final FortressGeneral general, Creature lastAttacker, FastList<PlayerGroup> rewardGroups, FastList<PlayerAllianceGroup> rewardAlliances)
	{
		...
		for(Entry<Integer, Integer> apResult : apRecords.get(general.getFortressId()).entrySet())
		{
            ...
            if(general.getFortressId() == 1011) {
                player.getCommonData().addAp(SiegeConfig.SIEGE_AP_REWARD_DIVINE);
            } else {
                player.getCommonData().addAp(SiegeConfig.SIEGE_AP_REWARD_DEFAULT);
            }
