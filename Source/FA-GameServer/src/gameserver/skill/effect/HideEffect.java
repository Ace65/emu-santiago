...
public class HideEffect extends BufEffect
{
	...
	public void endEffect(Effect effect)
	{
        ...
        // zer0patches Testing: Hide state should not be removed if in shadow walk. (Skill 948, Effect ID 165)
        // TODO: Check for better solution
        if (effected.getEffectController().hasAbnormalEffect(948)) {
            if(effected.getEffectController().hasAbnormalEffect(559) || effected.getEffectController().hasAbnormalEffect(582)){
                return;
            }
        }
