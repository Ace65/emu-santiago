...
public enum CustomMessageId
{
    ...
    ANNOUNCE_GM_CONNECTION("%s just entered into Atreia."),
        ...
        CHANNEL_SPAM("You can't use chat channels because spam, wait a few seconds."),
        ...
        WEDDING_NOT_MARRIED("You need to be married to be able to use this command."),
        WEDDING_LOVE_NOT_ONLINE("Your love is not online yet"),
        WEDDING_LOVE_NOT_PORTALBLE("You can't go to your love yet"),
        WEDDING_DIVORCE_OFFLINE("Your Partner must be online for divorce"),
        WEDDING_DIVORCE_ALL_OK("You successful divorced from %s"),
    
    	STEELRAKE_BOSS_ATTACKED("Divine Crusader is under attack!");
